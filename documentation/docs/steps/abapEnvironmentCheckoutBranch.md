...
Switches between branches of a git repository on a SAP BTP ABAP Environment system
...
!!! tip ""
    ...
    === "Command Line"
        ...
        ```sh
        piper abapEnvironmentCheckoutBranch
        ```
...
Specifies a Branch of a Repository (Software Component) on the SAP BTP ABAP Environment system
...
| Scope | Details |
| ---- | --------- |
| Aliases | - `cloudFoundry/serviceKey`<br />- `cloudFoundry/serviceKeyName`<br />- `cfServiceKeyName` |
| Type | `string` |
| Mandatory | no |
